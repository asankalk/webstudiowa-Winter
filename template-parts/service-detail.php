...
<section class="section image-feature">
    <div class="container image-feature__grid">
        <img class="service-support-image" src="<?php echo esc_url($service['support_image']); ?>" alt="<?php echo esc_attr($service['support_image_alt'] ?? ($service['title'] . ' visual')); ?>" width="900" height="675" loading="lazy" decoding="async">
        <div>
