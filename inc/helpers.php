...
function wswa_services(): array
{
    return [
        [
            ...
            'image' => wswa_asset('img/service-web-design.png'),
            'hero_image' => wswa_asset('img/service-web-design.png'),
            'support_image' => 'https://wordpress.validthemes.net/avrix/wp-content/uploads/2023/07/1.png',
        ...
        [
            ...
            'image' => wswa_asset('img/service-website-redesign.png'),
            'hero_image' => wswa_asset('img/service-website-redesign.png'),
            'support_image' => 'https://wordpress.validthemes.net/avrix/wp-content/uploads/2023/07/2-1.jpg',
        ...
        [
            ...
            'image' => wswa_asset('img/service-website-maintenance.png'),
            'hero_image' => wswa_asset('img/service-website-maintenance.png'),
            'support_image' => 'https://wordpress.validthemes.net/avrix/wp-content/uploads/2023/07/5.png',
...
function wswa_clients(): array
{
    return [
        [
            ...
            'image' => wswa_live_image('2025/03/Vending-WA-Logo-1.png'),
        ],
        [
            'name' => 'Pretium Group',
            'type' => 'New Website',
            'url' => 'https://www.pretiumgroup.com.au/',
            'image' => wswa_live_image('2025/03/Pretium-Lending-Logo-1.png'),
        ],
        [
            'name' => 'Cricketers Club',
            'type' => 'Website Maintenance',
            'url' => 'https://cricketersclub.com.au/',
            'image' => wswa_live_image('2025/03/cricketers-club-logo.png'),
        ],
        [
            'name' => 'Pretium Funding',
            'type' => 'Website Redesign',
            'url' => 'https://www.pretiumfunding.com.au/',
            'image' => wswa_live_image('2025/03/pretium-funding-logo-1.png'),
        ],
        [
            'name' => 'HP Debt Solutions',
            'type' => 'Website Redesign',
            'url' => 'https://www.hpdebtsolutions.com.au/',
            'image' => wswa_live_image('2025/03/hp-debt-solutions-logo-1.png'),
        ],
    ];
}
...
function wswa_defaults(): array
{
    return [
        ...
        'hero_image' => 'https://wordpress.validthemes.net/avrix/wp-content/uploads/2023/07/1.jpg',
        'stats' => [
